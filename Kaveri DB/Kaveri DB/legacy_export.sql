-- ==========================================================================
--  STAGE 1 WARM-UP  —  The Legacy Export
--
--  This is a real export from the old booking system that Kaveri Stays
--  ran on a spreadsheet for eleven years. Every column is TEXT, because
--  that is how it came out of the spreadsheet.
--
--  Load it with:
--      createdb kaveri
--      psql -d kaveri -f legacy_export.sql
--
--  Do not "fix" this file. Your job is to read it, understand how bad
--  it is, and migrate it into a clean schema of your own design.
-- ==========================================================================
...
CREATE TABLE legacy_reservations (
    ...
    hotel_city      TEXT,
    hotel_star      TEXT,
    room_numbers    TEXT,   -- yes, plural. sometimes several per booking.
    room_type       TEXT,
    guests_count    TEXT,
    checkin         TEXT,
    checkout        TEXT,
...
-- ==========================================================================
--  Have a look at what you have been given.
-- ==========================================================================
SELECT COUNT(*) AS total_rows FROM legacy_reservations;
